...
namespace AnBRobotSystem.ChildForm
{
    public partial class Main_process : Sunny.UI.UIForm
    {
        ...
        public void ui_updata()
        {
            ...
            try
            {
                ...
                if (AnBRobotSystem.MdiParent.PLCdata1.ZT_data.TB_pos == false)
                {
                    ...
                    aim_weight_uiLabel3.Text = AnBRobotSystem.MdiParent.Aim_weight;
                ...
                //B折铁实时显示
                if (AnBRobotSystem.MdiParent.zt_state.Has_mission && AnBRobotSystem.MdiParent.atuomodel.one_ZT != null)
                {
                    if (AnBRobotSystem.MdiParent.zt_state.GB_station == "B")
                    {
                ...
                //A折铁实时显示
                if (AnBRobotSystem.MdiParent.Azt_state.Has_mission && AnBRobotSystem.MdiParent.atuomodelA.one_ZT != null)
                {
                    if (AnBRobotSystem.MdiParent.Azt_state.GB_station == "A")
                    {
                        if (AnBRobotSystem.MdiParent.Azt_state.TB_BK_vision)
                            A_TBK_vision.Color = Color.LightGreen;
                        else
                            A_TBK_vision.Color = Color.Silver;

                        if (AnBRobotSystem.MdiParent.Azt_state.GB_GK_vision)
                        ...
                        switch (AnBRobotSystem.MdiParent.Azt_state.GB_speed.ToString())
                        {
                            //361703  低速倾翻
                            //361699高度倾翻
                            //361702 低速返回
        ...
        private void weight_speed_uiLabel_Click(object sender, EventArgs e)
        {
