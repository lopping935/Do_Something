...
namespace AnBRobotSystem
{
    ...
    public partial class MdiParent :Sunny.UI.UIForm
    {
        ...
        string SolutionPath = @"C:\ProjSetup\Auto_steel3_4_double\newvm\autosteelvm.sol";
       ...
       //标题栏  窗体切换代码
        ...
        private void startB_ZT_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBoxButtons messButton = MessageBoxButtons.OKCancel;
                DialogResult dr = MessageBox.Show("请先设置目标重量", "系统警报", messButton);
            ...
            {
                MessageBoxButtons messButton = MessageBoxButtons.OKCancel;
                DialogResult dr = MessageBox.Show("A折铁位未进入返回状态！", "系统警报", messButton);
                Program.GB_chose_flag = 0;
                return;
            }
            ...
            {
                MessageBoxButtons messButton = MessageBoxButtons.OKCancel;
                DialogResult dr = MessageBox.Show("视觉平台启动失败，请重启程序！", "系统错误", messButton);
                Program.GB_chose_flag = 0;
                return;
            }
            else
        ...
        private void startA_ZT_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBoxButtons messButton = MessageBoxButtons.OKCancel;
                DialogResult dr = MessageBox.Show("请先设置目标重量", "退出系统", messButton);
                Program.GB_chose_flag = 0;
                return;
            }
