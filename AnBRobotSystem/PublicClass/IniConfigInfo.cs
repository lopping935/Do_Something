...
namespace PublicClass
{
    public class IniSqlConfigInfo
    {
        ...
        public string  GetConnectionString(string Section,string SDKPass="")
        {
            ...
            {
                return "User Id=IMAGE;Password=6923263;Data Source=(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=192.168.0.115)(PORT=1521)))(CONNECT_DATA=(SERVICE_NAME=ORCL)));Enlist=true;Pooling=true;Max Pool Size=300;Min Pool Size=0;Connection Lifetime=300";
            }
