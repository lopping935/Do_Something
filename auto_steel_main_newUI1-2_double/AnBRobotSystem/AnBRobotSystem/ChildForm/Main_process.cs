    ...
    public partial class Main_process : Sunny.UI.UIForm
    {
        ...
        public void ui_updata()
        {
            ...
            try
            {
                ...
                //折铁实时显示
                if (AnBRobotSystem.MdiParent.zt_state.Has_mission && AnBRobotSystem.MdiParent.atuomodel.ZT_program_flag>1&& AnBRobotSystem.MdiParent.atuomodel.ZT_program_flag < 6)
                {
                ...
                if (AnBRobotSystem.MdiParent.Azt_state.Has_mission && AnBRobotSystem.MdiParent.atuomodelA.ZT_program_flag > 1 && AnBRobotSystem.MdiParent.atuomodelA.ZT_program_flag < 6)
                {
                    aim_weight_uiLabel3.Text = AnBRobotSystem.MdiParent.atuomodel.one_ZT.ZT_reqweight.ToString();
                    weight_speed_uiLabel.Text = AnBRobotSystem.MdiParent.PLCdata1.TB_weight_speed.ToString();
                    //zt_gb.Text = AnBRobotSystem.MdiParent.zt_state.GB_station;
