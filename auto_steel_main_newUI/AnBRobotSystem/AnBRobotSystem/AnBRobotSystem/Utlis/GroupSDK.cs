...
namespace SDK
{
    public class GroupSDK
    {
        ...
        [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
        public struct IRREGULAR_ROIS
        {
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)]
            public IRREGULAR_ROI[] ROIs;
        }

        [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
        public struct RECT_ROIS
        {
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)]
            public RECT_ROI[] ROIs;
        }
        ...
        /// <param name="intDataLength"></param>
        /// <param name="pUserData"></param>
        ...
        /// </summary>
        /// <param name="hDevice"></param>
        /// <param name="pReports"></param>
        /// <param name="intROINum"></param>
        /// <param name="pUserData"></param> 
        public delegate void DelegateROIReport(uint hDevice, IntPtr pReports, uint intROINum, IntPtr pUserData);

        /// <summary>
        /// IrregularROI Report 回调, 底层
        ...
        /// <param name="intROINum"></param>
        /// <param name="pUserData"></param> 
        public delegate void DelegateIrregularROIReportBottomLayer(uint hDevice, IntPtr pReports, uint intROINum, IntPtr pUserData);

        /// <summary>
        /// IrregularROI Report 回调，用户层
        /// </summary>
        /// <param name="hDevice"></param>
        /// <param name="reportList"></param>
        /// <param name="intROINum"></param>
        /// <param name="pUserData"></param>
        public delegate void DelegateIrregularROIReport(uint hDevice, IRREGULAR_ROI_REPORT[] reportList, uint intROINum, IntPtr pUserData);
        #endregion
	    ...
	    //_stdcall BOOL MAG_LinkCameraEx(UINT intChannelIndex, UINT intIP, USHORT shortCmdPort, USHORT shortImgPort, const char * charCloudUser, const char * charCloudPwd, UINT intCamSN, const char * charCamUser, const char * charCamPwd, UINT intTimeoutMS);
        ///</summary>
        /// <param name="intChannelIndex">相机对应的通道号</param>
        /// <param name="intIP">相机IP，网络字节序。</param>
        /// <param name="shortCmdPort">相机指令端口号。</param>
        /// <param name="shortImgPort">相机图像端口号。</param>
        ...
        public static extern bool MAG_LinkCameraEx(uint hDevice, uint ip, ushort shortCmdPort, ushort shortImgPort, [MarshalAs(UnmanagedType.LPStr)] string charCloudUser, 
        ...
        /// </summary>
        /// <param name="hDevice"></param>
        /// <param name="CamInfoEx"></param>
        /// <param name="intSize"></param>
        /// <returns></returns>
        [DllImport("ThermoGroupSDKLib.dll", EntryPoint = "MAG_GetCamInfoEx")]
        public static extern void MAG_GetCamInfoEx(uint hDevice, ref CAMERA_INFO_EX CamInfoEx, int intSize);
        ...
        /// </summary>
        /// <param name="hDevice">相机句柄</param>
        /// <param name="pRGBBuffer">输入数据指针，缓冲区可用尺寸BMPWidth*BMPHeight*3字节，in</param>
	    /// <param name="intBufferSize">缓冲区，尺寸BMPWidth*BMPHeight*3字节，in</param>
        /// <param name="bOrderBGR">FALSE - RGB; TRUE - BGR</param>
        /// <returns></returns>
        [DllImport("ThermoGroupSDKLib.dll", EntryPoint = "MAG_GetOutputBMPdataRGB24")]
        public static extern bool MAG_GetOutputBMPdataRGB24(uint hDevice, IntPtr pData, uint size, bool bOrderBGR);
        ...
        public static extern float MAG_SetFixPara(uint hDevice, ref FIX_PARAM pParam, bool bEnableCameraCorrect);
        ...
        /// <returns></returns>
        [DllImport("ThermoGroupSDKLib.dll", EntryPoint = "MAG_GetLineTemperatureInfo2")]
        public static extern int MAG_GetLineTemperatureInfo2(uint hDevice, uint x0, uint y0, uint x1, uint y1, [MarshalAs(UnmanagedType.LPArray, SizeConst = 5)] int[] info);
        ...
        /// </summary>
        /// <param name="hDevice">相机句柄</param>
        /// <param name="sFileName">AVI输出文件路径</param>
        /// <param name="samplePeriod">采样周期（帧）</param>
        /// <returns></returns>
        [DllImport("ThermoGroupSDKLib.dll", EntryPoint = "MAG_LocalStorageAviStart")]
        public static extern bool MAG_LocalStorageAviStart(uint hDevice, [MarshalAs(UnmanagedType.LPWStr)] string sFileName, uint samplePeriod);
        ...
        /// <param name="hDevice">相机句柄</param>
        /// <returns></returns>
        [DllImport("ThermoGroupSDKLib.dll", EntryPoint = "MAG_LocalStorageAviStop")]
        public static extern void MAG_LocalStorageAviStop(uint hDevice);
        ...
        /// <param name="samplePeriod">采样周期（帧）</param>
        /// <returns></returns>
        [DllImport("ThermoGroupSDKLib.dll", EntryPoint = "MAG_LocalStorageMgsRecord")]
        public static extern bool MAG_LocalStorageMgsRecord(uint hDevice, [MarshalAs(UnmanagedType.LPWStr)] string sFileName, uint samplePeriod);
        ...
        /// <param name="pUserData">用户数据</param>
        /// <returns></returns>
        [DllImport("ThermoGroupSDKLib.dll", EntryPoint = "MAG_LocalStorageMgsPlay")]
        public static extern int MAG_LocalStorageMgsPlay(uint hDevice, [MarshalAs(UnmanagedType.LPWStr)] string sFileName, DelegateNewFrame newFrame, IntPtr pUserData);
        ...
        /// <returns></returns>
        [DllImport("ThermoGroupSDKLib.dll", EntryPoint = "MAG_LocalStorageMgsSeekFrame")]
        public static extern bool MAG_LocalStorageMgsSeekFrame(uint hDevice, uint hFrame);
        ...
        /// <param name="hDevice">相机句柄</param>
        /// <returns></returns>
        [DllImport("ThermoGroupSDKLib.dll", EntryPoint = "MAG_LocalStorageMgsPopFrame")]
        public static extern bool MAG_LocalStorageMgsPopFrame(uint hDevice);
        ...
        /// <param name="hDevice">相机句柄</param>
        /// <returns></returns>
        [DllImport("ThermoGroupSDKLib.dll", EntryPoint = "MAG_LocalStorageMgsStop")]
        public static extern void MAG_LocalStorageMgsStop(uint hDevice);
        ...
        public static extern int MAG_EstimateUnderArmTempFromForeheadRect(uint hDevice, uint x0, uint y0, uint x1, uint y1);
        
        /// <summary>
        /// 对于内嵌可见光相机的热像仪，可通过本函数转换两个相机之间的坐标
        /// MAG_API BOOL WINAPI MAG_ConvertIrCorr2VisCorr(UINT intChannelIndex, int intIrX, int intIrY, float fDistance, int * intVisX, int * intVisY);
        /// </summary>
        /// <param name="hDevice"></param>
        /// <param name="intIrX"></param>
        /// <param name="intIrY"></param>
        /// <param name="fDistance"></param>
        /// <param name="intVisX"></param>
        /// <param name="intVisY"></param>
        /// <returns></returns>
        [DllImport("ThermoGroupSDKLib.dll", EntryPoint = "MAG_ConvertIrCorr2VisCorr")]
        public static extern bool MAG_ConvertIrCorr2VisCorr(uint hDevice, int intIrX, int intIrY, float fDistance, ref int intVisX, ref int intVisY);

        /// <summary>
        /// 对于内嵌可见光相机的热像仪，可通过本函数转换两个相机之间的坐标
        /// MAG_API BOOL WINAPI MAG_ConvertVisCorr2IrCorr(UINT intChannelIndex, int intVisX, int intVisY, float fDistance, int * intIrX, int * intIrY);
        /// </summary>
        /// <param name="hDevice"></param>
        /// <param name="intVisX"></param>
        /// <param name="intVisY"></param>
        ...
        /// <param name="intIrY"></param>
        /// <returns></returns>
        [DllImport("ThermoGroupSDKLib.dll", EntryPoint = "MAG_ConvertVisCorr2IrCorr")]
        public static extern bool MAG_ConvertVisCorr2IrCorr(uint hDevice, int intVisX, int intVisY, float fDistance, ref int intIrX, ref int intIrY);
        ...
        /// <returns></returns>
        [DllImport("ThermoGroupSDKLib.dll", EntryPoint = "MAG_SaveFIR")]
        public static extern bool MAG_SaveFIR(uint hDevice, [MarshalAs(UnmanagedType.LPWStr)] string sFileName);
        
        /// <summary>
        /// 未连接相机的状态下离线分析已保存的FIR格式的文件，用户应该在使用本函数之前配置好图像处理参数。
        /// MAG_API BOOL WINAPI MAG_LoadFIR(UINT intChannelIndex, OutputPara * paraOut, const WCHAR * charFilename, MAG_FRAMECALLBACK funcFrame, void * pUserData);
        /// </summary>
        /// <param name="hDevice"></param>
        ...
        /// <param name="pUserData"></param>
        /// <returns></returns>
        [DllImport("ThermoGroupSDKLib.dll", EntryPoint = "MAG_LoadFIR")]
        public static extern bool MAG_LoadFIR(uint hDevice, ref OUTPUT_PARAM param, [MarshalAs(UnmanagedType.LPWStr)] string sFileName, DelegateNewFrame newFrame, IntPtr pUserData);
        ...
        public static extern bool MAG_SetSerialCallBack(uint hDevice, DelegateSerial pCallBack, IntPtr pUserData);
        ...
        [DllImport("ThermoGroupSDKLib.dll", EntryPoint = "SetIoAlarmState")]
        public static extern bool MAG_SetIoAlarmState(uint hDevice, bool bAlarm);
        ...
        /// <param name="intROINum"></param>
        /// <returns></returns>
        [DllImport("ThermoGroupSDKLib.dll", EntryPoint = "MAG_SetUserROIsEx")]
        public static extern bool MAG_SetUserROIsEx(uint hDevice, ref RECT_ROIS rois, uint intROINum);
        ...
        /// <param name="intROINum"></param>
        /// <returns></returns>
        [DllImport("ThermoGroupSDKLib.dll", EntryPoint = "MAG_SetIrregularROIs")]
        public static extern bool MAG_SetIrregularROIs(uint hDevice, ref IRREGULAR_ROIS rois, uint intROINum);
        ...
        /// <param name="pUserData"></param>
        /// <returns></returns>
        [DllImport("ThermoGroupSDKLib.dll", EntryPoint = "MAG_SetROIReportCallBack")]
        public static extern bool MAG_SetROIReportCallBack(uint hDevice, DelegateROIReport pCallBack, IntPtr pUserData);
        ...
        public static extern bool MAG_SetIrregularROIReportCallBack(uint hDevice, DelegateROIReport pCallBack, IntPtr pUserData);
        ...
        public static extern bool MAG_SetIrregularROIReportExCallBack(uint hDevice, DelegateIrregularROIReportBottomLayer pCallBack, IntPtr pUserData);
        ...
        /// </summary>
        /// <param name="hDevice"></param>
        /// <param name="intLowerLimit"></param>
        /// <param name="intUpperLimit"></param>
        /// <returns></returns>
        ...
        /// <param name="B"></param>
        /// <returns></returns>
        [DllImport("ThermoGroupSDKLib.dll", EntryPoint = "MAG_SetIsothermalParaEx")]
        public static extern void MAG_SetIsothermalParaEx(uint hDevice, int intLowerLimit, int intUpperLimit, byte R, byte G, byte B);
        ...
        /// </summary>
        /// <param name="hDevice"></param>
        /// <param name="intEnhancedRatio"></param>
        /// <param name="x0"></param>
        /// <param name="y0"></param>
        /// <param name="x1"></param>
        /// <param name="y1"></param>
        /// <returns></returns>
        [DllImport("ThermoGroupSDKLib.dll", EntryPoint = "MAG_SetEnhancedROI")]
        public static extern void MAG_SetEnhancedROI(uint hDevice, uint intEnhancedRatio, uint x0, uint y0, uint x1, uint y1);
        ...
        public static extern bool MAG_GetApproximateGray2TemperatureLUT(uint hDevice, ref int pLut, uint intBufferSize);
