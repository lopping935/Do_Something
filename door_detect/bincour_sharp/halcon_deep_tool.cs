        ...
        public partial class HDevelopExport
        {
                ...
                out HTuple hv_Colors)
            {
                ...
                try
                {
                    ...
                    for (hv_ColorIndex = 0; hv_ColorIndex.Continue(end_val15, step_val15); hv_ColorIndex = hv_ColorIndex.TupleAdd(step_val15))
                    {
                        ...
                        using (HDevDisposeHelper dh = new HDevDisposeHelper())
                        {
                            HOperatorSet.SetColor(hv_ExpDefaultWinHandle, hv_WeightsColorsAlpha.TupleSelect(
                                hv_ColorIndex));
                        }
                ...
                try
                {
                            ...
                            new HTuple())))) != 0)
                        {
                                ...
                                )) - 1); hv_WindowIndex = (int)hv_WindowIndex + 1)
                            {
                                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                                {
                                    ...
                                    HOperatorSet.GetWindowParam(hv_ExpDefaultWinHandle, "flush", out hv_FlushValue);
                                }
                                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                                {
                                    {
                        ...
                        )) - 1); hv_KeyIndex = (int)hv_KeyIndex + 1)
                    {
                            ...
                            "image"))) != 0)
                        {
                            ...
                            {
                                HOperatorSet.DispText(hv_ExpDefaultWinHandle, hv_ImageIDStringCapital,
                            ...
                            "anomaly_ground_truth"))) != 0)
                        {
                            ...
                            if ((int)(hv_ShowBottomDesc) != 0)
                            {
                                HOperatorSet.DispText(hv_ExpDefaultWinHandle, hv_Text, "window", "bottom",
                            ...
                            if ((int)(hv_ShowLegend) != 0)
                            {
                                ...
                                HOperatorSet.DispText(hv_ExpDefaultWinHandle, hv_Text, "window", "top",
                                    "left", "white", "box", "false");
                            }
                        }
                        else if ((int)(new HTuple(((hv_KeysForDisplay.TupleSelect(hv_KeyIndex))).TupleEqual(
                            ...
                            "anomaly_image"))) != 0)
                        {
                            ...
                            //
                            HOperatorSet.DispObj(ho_AnomalyImage, hv_ExpDefaultWinHandle);
                            hv_Text.Dispose();
                            using (HDevDisposeHelper dh = new HDevDisposeHelper())
                            {
                            ...
                            "classification_ground_truth"))) != 0)
                        {
                            ...
                            if ((int)(hv_ShowLegend) != 0)
                            {
                                ...
                                {
                                    HOperatorSet.DispText(hv_ExpDefaultWinHandle, hv_Text, "window", "top",
                                        "left", (new HTuple("white")).TupleConcat(hv_Colors.TupleSelect(hv_ClassificationLabelIDGroundTruth)),
                                        "box", "false");
                                }
                            }
                        }
                            ...
                            "classification_result"))) != 0)
                        {
                            ...
                            if ((int)(hv_ShowClassificationIDs) != 0)
                            {
                                ...
                                HOperatorSet.GetFontExtents(hv_ExpDefaultWinHandle, out hv__, out hv__,
                                ...
                                if ((int)(hv_ShowBottomDesc) != 0)
                                {
                                    using (HDevDisposeHelper dh = new HDevDisposeHelper())
                                    {
                                        HOperatorSet.DispText(hv_ExpDefaultWinHandle, hv_Text, "window", hv_CurrentWindowHeight - ((hv_MarginBottom + hv_MaxHeight) + 10),
                                            "left", "white", "box", "false");
                                    }
                                }
                                else
                            ...
                            if ((int)(hv_ShowLegend) != 0)
                            {
                                ...
                                {
                                    HOperatorSet.DispText(hv_ExpDefaultWinHandle, hv_Text, "window", "top",
                                        "left", (new HTuple("white")).TupleConcat(hv_Colors.TupleSelect(hv_ClassificationLabelIDResult)),
                                        "box", "false");
                                }
                            }
                        }
                            ...
                            "classification_both"))) != 0)
                        {
                            ...
                            if ((int)(hv_ShowClassificationColorFrame) != 0)
                            {
                                ...
                                HOperatorSet.SetLineWidth(hv_ExpDefaultWinHandle, 7);
                                HOperatorSet.SetColor(hv_ExpDefaultWinHandle, hv_PredictionColor);
                                HOperatorSet.DispObj(ho_Image, hv_ExpDefaultWinHandle);
                                HOperatorSet.DispObj(ho_PredictionColorFrame, hv_ExpDefaultWinHandle);
                            }
                            else
                            {
                                HOperatorSet.DispObj(ho_Image, hv_ExpDefaultWinHandle);
                            ...
                            hv_KeyIndex))).TupleEqual("heatmap_confidence_based")))) != 0)
                        {
                            ...
                            //
                            HOperatorSet.DispObj(ho_ImageHeatmap, hv_ExpDefaultWinHandle);
                            if ((int)(hv_ShowBottomDesc) != 0)
                            {
                                hv_Text.Dispose();
                                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                            ...
                            "segmentation_weight"))) != 0)
                        {
                            ...
                            //
                            HOperatorSet.DispObj(ho_ImageWeight, hv_ExpDefaultWinHandle);
                            if ((int)(hv_ShowBottomDesc) != 0)
                            {
                                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                                {
                                    HOperatorSet.DispText(hv_ExpDefaultWinHandle, "Weight image " + hv_ImageIDStringBraces,
                                        "window", "bottom", "left", "white", "box", "false");
                                }
                            }
                        }
                            ...
                            "segmentation_confidence"))) != 0)
                        {
                            ...
                            //
                            HOperatorSet.DispObj(ho_ImageConfidence, hv_ExpDefaultWinHandle);
                            if ((int)(hv_ShowBottomDesc) != 0)
                            {
                                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                                {
                                    HOperatorSet.DispText(hv_ExpDefaultWinHandle, "Confidence image " + hv_ImageIDStringBraces,
                                        "window", "bottom", "left", "white", "box", "false");
                                }
                            }
                        }
                            ...
                            "bbox_result"))) != 0)
                        {
                            ...
                            if ((int)(hv_ShowLegend) != 0)
                            {
                                ...
                                HOperatorSet.DispText(hv_ExpDefaultWinHandle, hv_Text, "window", "top",
                                    "left", hv_BboxColorsResults, "box", "false");
                            }
                        }
                        else if ((int)(new HTuple(((hv_KeysForDisplay.TupleSelect(hv_KeyIndex))).TupleEqual(
                            "bbox_both"))) != 0)
                        {
                            ...
                            if ((int)(hv_ShowLegend) != 0)
                            {
                                ...
                                HOperatorSet.DispText(hv_ExpDefaultWinHandle, hv_Text, "window", "top",
                                    "left", hv_BboxColorsBoth, "box", "false");
                            }
                        }
                        else if ((int)(new HTuple(((hv_KeysForDisplay.TupleSelect(hv_KeyIndex))).TupleEqual(
                            "segmentation_image_ground_truth"))) != 0)
                        {
                            ...
                            HOperatorSet.SetDraw(hv_ExpDefaultWinHandle, hv_SegDraw);
                            hv_Width.Dispose();
                            HOperatorSet.GetLineWidth(hv_ExpDefaultWinHandle, out hv_Width);
                            ...
                            using (HDevDisposeHelper dh = new HDevDisposeHelper())
                            {
                                HOperatorSet.SetLineWidth(hv_ExpDefaultWinHandle, hv_Width.TupleInt());
                            }
                            hv_Text.Dispose();
                            using (HDevDisposeHelper dh = new HDevDisposeHelper())
                            {
                            ...
                            if ((int)(hv_ShowLegend) != 0)
                            {
                                ...
                                {
                                    HOperatorSet.DispText(hv_ExpDefaultWinHandle, hv_Text, "window", "top",
                                        "left", (new HTuple("white")).TupleConcat(hv_Colors.TupleSelect(hv_ImageClassIDsUniq)),
                                        "box", "false");
                                }
                            }
                        }
                            ...
                            "segmentation_image_both"))) != 0)
                        {
                            ...
                            HOperatorSet.SetLineWidth(hv_ExpDefaultWinHandle, 6);
                            ...
                            if ((int)(hv_ShowLegend) != 0)
                            {
                                ...
                                {
                                    HOperatorSet.DispText(hv_ExpDefaultWinHandle, hv_Text, "window", "top",
                                        "left", (((new HTuple("white")).TupleConcat(hv_Colors.TupleSelect(
                            ...
                            "segmentation_image_diff"))) != 0)
                        {
                            ...
                            if ((int)(new HTuple(hv_Min.TupleNotEqual(hv_Max))) != 0)
                            {
                                ...
                                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                                {
                                    HOperatorSet.SetColor(hv_ExpDefaultWinHandle, "#ff0000" + hv_SegTransparency);
                                }
                                HOperatorSet.DispObj(ho_DiffRegion, hv_ExpDefaultWinHandle);
                            }
                            else
                            {
                                HOperatorSet.DispText(hv_ExpDefaultWinHandle, "No difference found.",
                            ...
                            "segmentation_weight_map"))) != 0)
                        {
                            ...
                            if ((int)(hv_ShowBottomDesc) != 0)
                            {
                                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                                {
                                    HOperatorSet.DispText(hv_ExpDefaultWinHandle, "Weight map " + hv_ImageIDStringBraces,
                                        "window", "bottom", "left", "white", "box", "false");
                                }
                            }
                        }
                            ...
                            "segmentation_confidence_map"))) != 0)
                        {
                            ...
                            if ((int)(hv_ShowBottomDesc) != 0)
                            {
                                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                                {
                                    HOperatorSet.DispText(hv_ExpDefaultWinHandle, "Confidence map " + hv_ImageIDStringBraces,
                                        "window", "bottom", "left", "white", "box", "false");
                                }
                            }
                        }
                                ...
                                )) - 1); hv_Index = (int)hv_Index + 1)
                            {
                                    ...
                                    new HTuple())))) != 0)
                                {
                                        ...
                                        )) - 1); hv_WindowIndex = (int)hv_WindowIndex + 1)
                                    {
                                        ...
                                        using (HDevDisposeHelper dh = new HDevDisposeHelper())
                                        {
                                            HOperatorSet.SetWindowParam(hv_ExpDefaultWinHandle, "flush", hv_FlushValues.TupleSelect(
                                                hv_Index));
                                        }
                                    }
                                }
                ...
                HTuple hv_AnomalyColorTransparency, out HTuple hv_AnomalyRegionExists)
            {
                ...
                try
                {
                    ...
                    HOperatorSet.GetRgba(hv_ExpDefaultWinHandle, out hv_Red, out hv_Green, out hv_Blue,
                        out hv_Alpha);
                        ...
                        -1))) != 0)
                    {
                        ...
                        if ((int)(new HTuple(hv_Area.TupleGreater(0))) != 0)
                        {
                            using (HDevDisposeHelper dh = new HDevDisposeHelper())
                            {
                                HOperatorSet.SetColor(hv_ExpDefaultWinHandle, hv_AnomalyRegionLabelColor + hv_AnomalyColorTransparency);
                            }
                            //Display the anomaly region.
                            HOperatorSet.SetDraw(hv_ExpDefaultWinHandle, "fill");
                            HOperatorSet.DispObj(ho_AnomalyRegion, hv_ExpDefaultWinHandle);
                        }
                        hv_AnomalyRegionExists.Dispose();
                    ...
                    //
                    //Reset colors.
                    HOperatorSet.SetColor(hv_ExpDefaultWinHandle, hv_InitialColor);
                    //
                    ho_AnomalyImage.Dispose();
                    ho_AnomalyRegion.Dispose();
                ...
                out HTuple hv_BboxIDs)
            {
                ...
                try
                {
                        ...
                        0))) != 0)
                    {
                        ...
                        //
                        HOperatorSet.SetLineWidth(hv_ExpDefaultWinHandle, hv_LineWidthBbox);
                        //
                        ...
                        HOperatorSet.GetContourStyle(hv_ExpDefaultWinHandle, out hv_ContourStyle);
                        HOperatorSet.SetContourStyle(hv_ExpDefaultWinHandle, "stroke_and_fill");
                            ...
                            )) - 1); hv_IndexBbox = (int)hv_IndexBbox + 1)
                        {
                            ...
                            using (HDevDisposeHelper dh = new HDevDisposeHelper())
                            {
                                HOperatorSet.SetColor(hv_ExpDefaultWinHandle, (hv_BboxColors.TupleSelect(
                                    hv_ClassID)) + "60");
                            }
                            HOperatorSet.DispObj(ho_RectangleSelected, hv_ExpDefaultWinHandle);
                                ...
                                hv_ShowDirection)) != 0)
                            {
                                ...
                                HOperatorSet.DispObj(ho_ArrowSelected, hv_ExpDefaultWinHandle);
                                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                                {
                                    HOperatorSet.SetColor(hv_ExpDefaultWinHandle, (hv_BboxColors.TupleSelect(
                                        hv_ClassID)) + "60");
                        ...
                        if ((int)(hv_ShowLabels) != 0)
                        {
                                ...
                                )) - 1); hv_IndexBbox = (int)hv_IndexBbox + 1)
                            {
                                ...
                                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                                {
                                    HOperatorSet.DispText(hv_ExpDefaultWinHandle, hv_BboxLabels.TupleSelect(
                                        hv_IndexBbox), "image", hv_LabelRow.TupleSelect(hv_IndexBbox), hv_LabelCol.TupleSelect(
                        ...
                        //
                        HOperatorSet.SetContourStyle(hv_ExpDefaultWinHandle, hv_ContourStyle);
                    }
                    else
                    {
                ...
                HTuple hv_WindowHandle)
            {
                ...
                try
                {
                    ...
                    for (hv_Row = hv_ImageHeight - 1; hv_Row.Continue(end_val13, step_val13); hv_Row = hv_Row.TupleAdd(step_val13))
                    {
                        ...
                        using (HDevDisposeHelper dh = new HDevDisposeHelper())
                        {
                            HOperatorSet.SetColor(hv_ExpDefaultWinHandle, hv_Colors.TupleSelect(hv_ColorIndex));
                        }
                    ...
                    HOperatorSet.GetStringExtents(hv_ExpDefaultWinHandle, "0123456789", out hv__,
                    ...
                    for (hv_Index = (double)(0); (double)hv_Index <= 1; hv_Index = (double)hv_Index + 0.2)
                    {
                        ...
                        using (HDevDisposeHelper dh = new HDevDisposeHelper())
                        {
                            HOperatorSet.DispText(hv_ExpDefaultWinHandle, hv_Text, "image", hv_Index * (hv_ImageHeight - (2 * (hv_TextHeight / hv_WindowImageRatio))),
                ...
                HTuple hv_AnomalyRegionResultColor)
            {
                ...
                try
                {
                    ...
                    if ((int)(new HTuple(hv_Area.TupleGreater(0))) != 0)
                    {
                        HOperatorSet.SetColor(hv_ExpDefaultWinHandle, hv_AnomalyRegionResultColor);
                        HOperatorSet.SetLineWidth(hv_ExpDefaultWinHandle, hv_LineWidth);
                        HOperatorSet.SetDraw(hv_ExpDefaultWinHandle, "margin");
                        HOperatorSet.DispObj(ho_AnomalyRegion, hv_ExpDefaultWinHandle);
                    }
                ...
                out HTuple hv_BboxIDs)
            {
                ...
                try
                {
                        ...
                        0))) != 0)
                    {
                        ...
                        HOperatorSet.SetDraw(hv_ExpDefaultWinHandle, "margin");
                        hv_Style.Dispose();
                        HOperatorSet.GetLineStyle(hv_ExpDefaultWinHandle, out hv_Style);
                        HOperatorSet.SetLineWidth(hv_ExpDefaultWinHandle, hv_LineWidthBbox);
                        //
                            ...
                            )) - 1); hv_IndexBbox = (int)hv_IndexBbox + 1)
                        {
                            ...
                            hv_LineWidth.Dispose();
                            HOperatorSet.GetLineWidth(hv_ExpDefaultWinHandle, out hv_LineWidth);
                            using (HDevDisposeHelper dh = new HDevDisposeHelper())
                            {
                            ...
                            using (HDevDisposeHelper dh = new HDevDisposeHelper())
                            {
                                HOperatorSet.SetColor(hv_ExpDefaultWinHandle, hv_Colors.TupleSelect(hv_ClassID));
                            }
                            HOperatorSet.DispObj(ho_RectangleSelected, hv_ExpDefaultWinHandle);
                            if ((int)((new HTuple(hv_InstanceType.TupleEqual("rectangle2"))).TupleAnd(
                                hv_ShowDirection)) != 0)
                        ...
                        if ((int)(hv_ShowLabels) != 0)
                        {
                                ...
                                )) - 1); hv_IndexBbox = (int)hv_IndexBbox + 1)
                            {
                                ...
                                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                                {
                                    HOperatorSet.DispText(hv_ExpDefaultWinHandle, hv_Text, "image", hv_TextRow,
                                        hv_LabelCol.TupleSelect(hv_IndexBbox), hv_TxtColor, ((new HTuple("box_color")).TupleConcat(
                        ...
                        //
                        HOperatorSet.SetDraw(hv_ExpDefaultWinHandle, hv_DrawMode);
                        HOperatorSet.SetLineStyle(hv_ExpDefaultWinHandle, hv_Style);
                    }
                    else
                    {
                ...
                try
                {
                        ...
                        )) - 1); hv_Index = (int)hv_Index + 1)
                    {
                        if ((int)(new HTuple(((hv_Area.TupleSelect(hv_Index))).TupleGreater(0))) != 0)
                        {
                            ...
                            using (HDevDisposeHelper dh = new HDevDisposeHelper())
                            {
                                HOperatorSet.SetColor(hv_ExpDefaultWinHandle, hv_ColorsSegmentation.TupleSelect(
                                    hv_IndexColor));
                            }
                            ...
                            HOperatorSet.DispObj(ho_SelectedRegion, hv_ExpDefaultWinHandle);
                        }
                    }
                    ho_Regions.Dispose();
                    ho_SelectedRegion.Dispose();
                ...
                HTuple hv_SegMaxWeight, out HTuple hv_Colors)
            {
                ...
                try
                {
                    ...
                    while ((int)(new HTuple(hv_GrayVal.TupleNotEqual(new HTuple()))) != 0)
                    {
                        ...
                        HOperatorSet.SetColor(hv_ExpDefaultWinHandle, hv_ClassColor);
                        HOperatorSet.DispObj(ho_WeightsRegion, hv_ExpDefaultWinHandle);
                    }
                    ho_Domain.Dispose();
                    ho_WeightsRegion.Dispose();
                ...
                HTuple hv_WindowHandleKey, out HTuple hv_WindowImageRatio, out HTuple hv_PrevWindowCoordinatesOut)
            {
                ...
                try
                {
                    ...
                    if ((int)(hv_OpenNewWindow.TupleNot()) != 0)
                    {
                        ...
                        set_display_font(hv_ExpDefaultWinHandle, hv_FontSize, hv_Font, "true", "false");
                        //
                        hv_MetaInfo.Dispose();
                        HOperatorSet.GetDictTuple(hv_WindowHandleDict, "meta_information", out hv_MetaInfo);
                        //
                        ...
                        HOperatorSet.GetWindowExtents(hv_ExpDefaultWinHandle, out hv_WindowRow, out hv_WindowColumn,
                        ...
                        catch (HalconException HDevExpDefaultException1)
                        {
                            ...
                            hv_WindowRow.Dispose(); hv_WindowColumn.Dispose(); hv_WindowWidth.Dispose(); hv_WindowHeight.Dispose();
                            HOperatorSet.GetWindowExtents(hv_ExpDefaultWinHandle, out hv_WindowRow,
                    ...
                    else
                    {
                        ...
                        open_child_window(hv_ExpDefaultWinHandle, hv_Font, hv_FontSize, hv_Text,
                            hv_PrevWindowCoordinates, hv_WindowHandleDict, hv_WindowHandleKey, out hv_ChildWindowHandle,
                            out hv_PrevWindowCoordinatesOut);
                        HOperatorSet.SetWindowParam(hv_ExpDefaultWinHandle, "flush", "false");
                        using (HDevDisposeHelper dh = new HDevDisposeHelper())
                        {
                ...
                out HTuple hv_PrevWindowCoordinatesOut)
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        {
                            hv_Value.Dispose();
                            HOperatorSet.GetWindowParam(hv_ExpDefaultWinHandle, "flush", out hv_Value);
                        }
                        // catch (Exception) 
                        catch (HalconException HDevExpDefaultException2)
                        {
                    ...
                    if ((int)(hv_OpenNewWindow.TupleNot()) != 0)
                    {
                        ...
                        update_window_meta_information(hv_ExpDefaultWinHandle, hv_WidthImage, hv_HeightImage,
                ...
                try
                {
                        ...
                        )) - 1); hv_IndexText = (int)hv_IndexText + 1)
                    {
                        using (HDevDisposeHelper dh = new HDevDisposeHelper())
                        {
                            ...
                            HOperatorSet.GetStringExtents(hv_ExpDefaultWinHandle, hv_Text.TupleSelect(
                ...
                out HTuple hv_PrevWindowCoordinatesOut)
            {
                ...
                try
                {
                    ...
                    HOperatorSet.GetWindowExtents(hv_ExpDefaultWinHandle, out hv__, out hv__, out hv_WindowWidth,
                        out hv_WindowHeight);
                ...
                out HTuple hv_SetPartRow2, out HTuple hv_SetPartColumn2, out HTuple hv_PrevWindowCoordinatesOut)
            {
                ...
                try
                {
                    ...
                    HOperatorSet.SetPart(hv_ExpDefaultWinHandle, 0, 0, hv_SetPartRow2, hv_SetPartColumn2);
                    //
                    //Return the coordinates of the new window.
                    hv_PrevWindowCoordinatesOut.Dispose();
                    using (HDevDisposeHelper dh = new HDevDisposeHelper())
            ...
            // Main procedure 
            public  HTuple action()
            {


                // Local iconic variables 

                HObject ho_ImageBatch, ho_Circle1 = null, ho_Circle2 = null;

                // Local control variables 

                HTuple hv_ShowExampleScreens = new HTuple();
                HTuple hv_UsePretrainedModel = new HTuple(), hv_ExampleDir = new HTuple();
                ...
                HTuple hv_NumberDetectionsPerClass = new HTuple(), hv_Max1 = new HTuple();
                HTuple hv_Min1 = new HTuple(), hv_Max2 = new HTuple();
                HTuple hv_Min2 = new HTuple(), hv_centerx = new HTuple();
                HTuple hv_centery = new HTuple(), hv_row1 = new HTuple();
                HTuple hv_col1 = new HTuple(), hv_index_flag1 = new HTuple();
                HTuple hv_index_flag2 = new HTuple(), hv_Distance1 = new HTuple();
                HTuple hv_Distance2 = new HTuple(), hv_dupli1 = new HTuple();
                HTuple hv_dupli2 = new HTuple(), hv_Index2 = new HTuple();
                HTuple hv_row2 = new HTuple(), hv_col2 = new HTuple();
                HTuple hv_circle_x1 = new HTuple(), hv_circle_y1 = new HTuple();
                HTuple hv_circle_x2 = new HTuple(), hv_circle_y2 = new HTuple();
                ...
                try
                {
                    ...
                    hv_ExampleDir.Dispose();
                    HOperatorSet.GetSystem("example_dir", out hv_ExampleDir);
                    //ImageDir := ExampleDir + '/images/pill_bag'
                    hv_ImageDir.Dispose();
                    hv_ImageDir = "C:/Users/Administrator/Desktop/testimg";
                    //
                    ...
                    using (HDevDisposeHelper dh = new HDevDisposeHelper())
                    {
                        hv_PreprocessParamFileName = hv_ExampleDataDir + "/dl_preprocess_param.hdict";
                    }
                    ...
                    HOperatorSet.ReadImage(out ho_ImageBatch, "E:/Learncode/halcon/myhalconcode/deep_learn/Lgao5cm.bmp");
                    //
                    ...
                    //first :get center point  then:offset col coordinate then:get two point
                    hv_Max1.Dispose();
                    HOperatorSet.TupleMax(hv_box_row1, out hv_Max1);
                    hv_Min1.Dispose();
                    HOperatorSet.TupleMin(hv_box_row1, out hv_Min1);
                    hv_Max2.Dispose();
                    HOperatorSet.TupleMax(hv_box_col1, out hv_Max2);
                    hv_Min2.Dispose();
                    HOperatorSet.TupleMin(hv_box_col1, out hv_Min2);
                    hv_centerx.Dispose();
                    using (HDevDisposeHelper dh = new HDevDisposeHelper())
                    {
                        hv_centerx = ((hv_Max1 - hv_Min1) / 2) + hv_Min1;
                    }
                    hv_centery.Dispose();
                    using (HDevDisposeHelper dh = new HDevDisposeHelper())
                    {
                        hv_centery = ((hv_Max2 - hv_Min2) / 2) + hv_Min2;
                    }
                    hv_row1.Dispose();
                    hv_row1 = 0;
                    hv_col1.Dispose();
                    hv_col1 = 0;
                    hv_index_flag1.Dispose();
                    hv_index_flag1 = 0;
                    hv_index_flag2.Dispose();
                    hv_index_flag2 = 0;
                    using (HDevDisposeHelper dh = new HDevDisposeHelper())
                    {
                        hv_Distance1.Dispose();
                        HOperatorSet.DistancePp(hv_centerx, hv_centery - 20, hv_box_row1.TupleSelect(
                            0), hv_box_col1.TupleSelect(0), out hv_Distance1);
                    }
                    using (HDevDisposeHelper dh = new HDevDisposeHelper())
                    {
                        hv_Distance2.Dispose();
                        HOperatorSet.DistancePp(hv_centerx, hv_centery + 20, hv_box_row1.TupleSelect(
                            0), hv_box_col1.TupleSelect(0), out hv_Distance2);
                    }
                    hv_dupli1.Dispose();
                    hv_dupli1 = new HTuple(hv_Distance1);
                    hv_dupli2.Dispose();
                    hv_dupli2 = new HTuple(hv_Distance2);
                    for (hv_Index2 = 1; (int)hv_Index2 <= 30; hv_Index2 = (int)hv_Index2 + 1)
                    {

                        using (HDevDisposeHelper dh = new HDevDisposeHelper())
                        {
                            hv_Distance1.Dispose();
                            HOperatorSet.DistancePp(hv_centerx, hv_centery - 30, hv_box_row1.TupleSelect(
                                hv_Index2), hv_box_col1.TupleSelect(hv_Index2), out hv_Distance1);
                        }
                        using (HDevDisposeHelper dh = new HDevDisposeHelper())
                        {
                            hv_Distance2.Dispose();
                            HOperatorSet.DistancePp(hv_centerx, hv_centery + 30, hv_box_row1.TupleSelect(
                                hv_Index2), hv_box_col1.TupleSelect(hv_Index2), out hv_Distance2);
                        }
                        if ((int)(new HTuple(hv_Distance1.TupleLess(hv_dupli1))) != 0)
                        {
                            hv_dupli1.Dispose();
                            hv_dupli1 = new HTuple(hv_Distance1);
                            hv_row1.Dispose();
                            using (HDevDisposeHelper dh = new HDevDisposeHelper())
                            {
                                hv_row1 = hv_box_row1.TupleSelect(
                                    hv_Index2);
                            }
                            hv_col1.Dispose();
                            using (HDevDisposeHelper dh = new HDevDisposeHelper())
                            {
                                hv_col1 = hv_box_col1.TupleSelect(
                                    hv_Index2);
                            }
                            hv_index_flag1.Dispose();
                            hv_index_flag1 = new HTuple(hv_Index2);
                        }
                        if ((int)(new HTuple(hv_Distance2.TupleLess(hv_dupli2))) != 0)
                        {
                            hv_dupli1.Dispose();
                            hv_dupli1 = new HTuple(hv_Distance1);
                            hv_row2.Dispose();
                            using (HDevDisposeHelper dh = new HDevDisposeHelper())
                            {
                                hv_row2 = hv_box_row1.TupleSelect(
                                    hv_Index2);
                            }
                            hv_col2.Dispose();
                            using (HDevDisposeHelper dh = new HDevDisposeHelper())
                            {
                                hv_col2 = hv_box_col1.TupleSelect(
                                    hv_Index2);
                            }
                            hv_index_flag2.Dispose();
                            hv_index_flag2 = new HTuple(hv_Index2);
                        }

                    }

                    hv_circle_x1.Dispose();
                    using (HDevDisposeHelper dh = new HDevDisposeHelper())
                    {
                        hv_circle_x1 = (hv_box_row1.TupleSelect(
                            hv_index_flag1)) + (((hv_box_row2.TupleSelect(hv_index_flag1)) - (hv_box_row1.TupleSelect(
                            hv_index_flag1))) / 2);
                    }
                    hv_circle_y1.Dispose();
                    using (HDevDisposeHelper dh = new HDevDisposeHelper())
                    {
                        hv_circle_y1 = (hv_box_col1.TupleSelect(
                            hv_index_flag1)) + (((hv_box_col2.TupleSelect(hv_index_flag1)) - (hv_box_col1.TupleSelect(
                            hv_index_flag1))) / 2);
                    }
                    hv_circle_x2.Dispose();
                    using (HDevDisposeHelper dh = new HDevDisposeHelper())
                    {
                        hv_circle_x2 = (hv_box_row1.TupleSelect(
                            hv_index_flag2)) + (((hv_box_row2.TupleSelect(hv_index_flag2)) - (hv_box_row1.TupleSelect(
                            hv_index_flag2))) / 2);
                    }
                    hv_circle_y2.Dispose();
                    using (HDevDisposeHelper dh = new HDevDisposeHelper())
                    {
                        hv_circle_y2 = (hv_box_col1.TupleSelect(
                            hv_index_flag2)) + (((hv_box_col2.TupleSelect(hv_index_flag2)) - (hv_box_col1.TupleSelect(
                            hv_index_flag2))) / 2);
                    }
                        ...
                        )) - 1); hv_Index = (int)hv_Index + 1)
                    {
                        ...
                        //distance_pp (NumberDetectionsPerClass, NumberDetectionsPerClass, NumberDetectionsPerClass, NumberDetectionsPerClass, Distance)
                    }
                    //
                ...
                HTuple outcenter = new HTuple();
                outcenter = new HTuple(hv_circle_x1/0.333,hv_circle_y1/0.4,hv_circle_x2/0.333,hv_circle_y2/0.4);
                return outcenter;
                //dev_display_dl_data(hv_DLSample, hv_DLResult, hv_DLDataInfo, "bbox_result",hv_GenParam, hv_ExpDefaultWinHandle);
                //ho_Circle1.Dispose();
                //HOperatorSet.GenCircle(out ho_Circle1, hv_circle_x1, hv_circle_y1, 3);
                //ho_Circle2.Dispose();
                //HOperatorSet.GenCircle(out ho_Circle2, hv_circle_x2, hv_circle_y2, 3);
                //hv_WindowHandles.Dispose();
                ...
                ////read_image (Image, 'E:/Learncode/halcon/myhalconcode/deep_learn/Lgao5cm.bmp')
                ////dev_display (Image)
                //HDevelopStop();
                ////endfor
