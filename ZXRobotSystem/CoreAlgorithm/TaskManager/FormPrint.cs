    ...
    public class FormPrint
    {
        ...
        private void Init_lable()
        {
            ...
            catch (Exception e)
            {
                ...
                Log.addLog(log, LogType.ERROR, e.ToString());
            }
        }
        ...
        private void CreateDataSet()
        {
            ...
            else
            {
                ...
                //barcodestring = "http://218.56.161.92:9700/Login/SaoMiao?linkid=16&lh=Y205-05486&zh=535&kh=3&cx=B14&mi=" + myserverclient.GetJiaMistr(PLClable.FUN_NO + "," + PLClable.XH);
