        ...
        public void ztlog()
        {
            if ((MdiParent.tl1.Get_iron || TB_weight_speed > 0.09))//&& ZT_data.TB_pos == false  
            {
                ...
                if (MdiParent.tl1.TL_station == "A")
                    log += Math.Round((ZT_data.GB_A_angle / 20), 2).ToString() + ",4号" + "," + MdiParent.tl1.Get_iron.ToString() + "," + ZT_data.TB_pos.ToString() + "," + GB_A_remind_weight + "," + hum_speed + "," + ZT_data.GB_A_speed;
                else if (MdiParent.tl1.TL_station == "B")
                    log += Math.Round((ZT_data.GB_B_angle / 20), 2).ToString() + ",3号" + "," + MdiParent.tl1.Get_iron.ToString() + "," + ZT_data.TB_pos.ToString() + "," + GB_B_remind_weight + "," + hum_speed + "," + ZT_data.GB_B_speed;
                else
