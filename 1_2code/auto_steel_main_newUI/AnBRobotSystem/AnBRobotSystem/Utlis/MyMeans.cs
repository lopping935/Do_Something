...
namespace AnBRobotSystem.DataClass
{
    ...
    class MyMeans
    {
        ...
        public static string Login_Pope = "";  //定义全局变量，记录当前登录用户权限
        public static bool globalVar = false;//用于程序运行的暂时全局判断变量
        ...
        public static string M_str_sqlcon = "Data Source=Localhost;Database=DBAnBRobotData;User id=sa;PWD=6923263;Enlist=true;Pooling=true;Max Pool Size=300;Min Pool Size=0;Connection Lifetime=300;packet size=1000";

        public static int Login_n = 0;  //用户登录与重新登录的标识
        public static string AllSql = "Select * from tb_Login";
