...
namespace AnBRobotSystem.Core
{
    ...
    {
        //public static Auto_model atuomodel_ja = new Auto_model();
        //public static Auto_model atuomodel_jb = new Auto_model();
                ...
                while (threadflag)
                {
                    ...
                    if (ZT_program_flag == 2)
                    {
                        ...
                        else
                        {
                            ...
                            LogHelper.loginfo.Info("角度过大未见铁流，进入11！");
                            ZT_program_flag = 11;
                            no_iron_angle = one_ZT.GB_angle;
                        }
                    ...
                    if (ZT_program_flag == 5)//&& MdiParent.tl1.TL_light_result() == true
                    {
                        if (one_ZT.TB_weight > one_ZT.ZT_reqweight * 0.95 && one_ZT.TB_weight < one_ZT.ZT_reqweight * 0.98)
                        {
                            if (MdiParent.tl1.Get_iron == true || MdiParent.PLCdata1.TB_weight_speed > 0.05)
                            {
                                ...
                                else if (MdiParent.PLCdata1.TB_weight_speed > full_speed * 0.6)////hr 本来是0.5
                                {
                        ...
                        else if (one_ZT.TB_weight >= one_ZT.ZT_reqweight * 0.98 && one_ZT.TB_weight < one_ZT.ZT_reqweight - 0.8)
                        {
                            if ((MdiParent.tl1.Get_iron == true || MdiParent.PLCdata1.TB_weight_speed > 0.05))
                            {
                                if (MdiParent.PLCdata1.TB_weight_speed > full_speed * 0.6)////////hr
                                {
                                ...
                                else if (MdiParent.PLCdata1.TB_weight_speed > full_speed * 0.25 && MdiParent.PLCdata1.TB_weight_speed <= full_speed * 0.6)//////////hr
                                {
                                    Program.testcode = "0.98_0.5";
                                ...
                                //else if (MdiParent.PLCdata1.TB_weight_speed < full_speed * 0.055)//////////hr
                                //{
                                //    Program.testcode = "0.98_0.2";
                                //    if (one_ZT.GB_speed == 10)
                                //        ZT_program_flag = 5;
                    ...
                    if (ZT_program_flag == 10)
                    {
                        ...
                        if (MdiParent.tl1.Get_iron == false)
                        {
                            ...
                            minute = (int)Math.Round(tl_ts_stop.TotalMinutes, 2);
                            second = ((double)Math.Round(tl_ts_stop.TotalMinutes, 2) - minute) * 0.6;
                            string state = "11-开流失败，折铁返回中铁流消失";
                            sqltext = string.Format("UPDATE RealTime SET fall_time='{0}',fall_weight='{1}',fall_state='{2}',tb_hight='{3}' WHERE startime= '{4}'", Math.Round(minute + second, 2).ToString(), one_ZT.TB_weight.ToString(), ztstate, (5404 - one_ZT.TB_hight).ToString(), beforDT);
                            dbhlper.MultithreadExecuteNonQuery(sqltext);
                            no_iron_angle = one_ZT.GB_angle;
                        }
                    }
                    ...
                    if (ZT_program_flag == 12)
                    {
                        ...
                        else
                        {
                            ...
                            //sqltext = string.Format("UPDATE RealTime SET stoptime= '{0}',back_time_return='{1}' WHERE startime= '{2}'", afterDT, Math.Round(minute + second, 2).ToString(), beforDT);
                            dbhlper.MultithreadExecuteNonQuery(sqltext);
                    ...
                    if (limt_has_set == 0)
                    {
                        ...
                        if (one_ZT.GB_angle > 2300 && limt_has_set == 0)//||MdiParent.PLCdata1.GB_A_remind_weight<300|| one_ZT.TB_weight >= one_ZT.ZT_reqweight + 15
                        {
                            if (ZT_program_flag != 6)
                            {
                                ztstate = "6-到达极限角度";
                        ...
                        else if (MdiParent.PLCdata1.ZT_data.TB_pos == true && limt_has_set == 0 /*&& atuomodel_ja.one_ZT.ZT_reqweight != -50 && atuomodel_jb.one_ZT.ZT_reqweight != -50*/)//||MdiParent.PLCdata1.GB_A_remind_weight<300|| one_ZT.TB_weight >= one_ZT.ZT_reqweight + 15
                        {
                            if (ZT_program_flag != 6)
                            {
                                ztstate = "6-铁包不在位";
                ...
                while (threadflag)
                {
                    ...
                    if (ZT_program_flag == 5)//&& MdiParent.tl1.TL_light_result() == true
                    {
                        if (one_ZT.TB_weight > one_ZT.ZT_reqweight * 0.95 && one_ZT.TB_weight < one_ZT.ZT_reqweight * 0.98)
                        {
                            if (MdiParent.tl1.Get_iron == true || MdiParent.PLCdata1.TB_weight_speed > 0.05)
                            {
                                ...
                                else if (MdiParent.PLCdata1.TB_weight_speed > full_speed * 0.6)///原来是0.5
                                {
                                    Program.testcode = "0.95_1";
                                    if (one_ZT.GB_speed == -10)
                                        ZT_program_flag = 5;
                    ...
                    if(ZT_program_flag==12)
                    {
                        ...
                        else
                        {
                            ...
                            LogHelper.loginfo.Info("罐包到达0位！，结束！");
                            MdiParent.PLCdata1.write_mission_signal(one_ZT.Has_mission);
                            ZT_program_flag = 0;
                            break;
                        }
                    ...
                    if (limt_has_set == 0)
                    {
                        ...
                        else if (MdiParent.PLCdata1.ZT_data.TB_pos == true && limt_has_set == 0 && one_ZT.ZT_reqweight != -50/*&& atuomodel_ja.one_ZT.ZT_reqweight != -50 && atuomodel_jb.one_ZT.ZT_reqweight != -50*/)
                        {
                            if (ZT_program_flag != 9)
                            {
                                ztstate = "9-铁包不在位";
