...
namespace Utlis
{
    ...
    {
        DbHelper db;
        public  string constring = "Data Source=.;Initial Catalog=Agfish;User ID=sa; Password=6923263;Enlist=true;Pooling=true;Max Pool Size=300;Min Pool Size=0;Connection Lifetime=300;packet size=1000";
