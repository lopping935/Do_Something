...
namespace SQLPublicClass
{
    public class DbHelper
    {
        ...
        private static string dbConnectionString = "Data Source=.;Initial Catalog=MDBAnBRobotData;User ID=sa; Password=6923263;Enlist=true;Pooling=true;Connection Timeout=30;Max Pool Size=300;Min Pool Size=0;Connection Lifetime=300;packet size=1000";
