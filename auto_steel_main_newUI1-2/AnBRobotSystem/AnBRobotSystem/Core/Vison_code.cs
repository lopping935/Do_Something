...
namespace AnBRobotSystem.Core
{
                    ...
                    try
                    {
                        if (GK_station == "A")
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    if (MdiParent.process_GK.GetFloatOutputResult("GB_A_edg").pFloatValue[0] > 200)
                        ...
                        else if (GK_station == "B")
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    if (MdiParent.process_GKB.GetFloatOutputResult("GB_B_edg").pFloatValue[0] > 200)
    ...
    public class TieLiu
    {
        ...
        public TieLiu()
        {
            m1.Initialize();
            CreateDevice();
            m1.LinkCamera("192.168.101.2", 2000);
