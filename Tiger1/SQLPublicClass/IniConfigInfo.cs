...
namespace SQLPublicClass
{
    public class IniSqlConfigInfo
    {
        ...
        public string  GetConnectionString(string Section,string SDKPass="")
        {
            ...
            {
                return "Data Source=.;Initial Catalog=Tiger;User ID=sa; Password=6923263;Enlist=true;Pooling=true;Max Pool Size=300;Min Pool Size=0;Connection Lifetime=300;packet size=1000";
            }
